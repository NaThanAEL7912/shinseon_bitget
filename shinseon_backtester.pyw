# -*- coding: utf-8 -*-
"""
신선(SHINSEON) 오더플로우 전문 독립 전략 백테스터 GUI (ShinSeon Strategy Backtester V7.75)
...
class ShinseonBacktesterGUI(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("신선(神選) 오더플로우 전문 독립 전략 백테스터 V7.75 [SHINSEON BACKTESTER]")
    ...
    def create_header_and_date_picker(self):
        ...
        top_h = QHBoxLayout()
        title_lbl = QLabel("<b style='font-size: 16px; color: #ffd700;'>神選 [SHINSEON] 전략 백테스터</b> <span style='color: #8b949e;'>V7.75 (미국 본장 스나이퍼 & 삼위일체 정통 청산)</span>")
